...
![image](/images/R2UWbLa34oFCItxsmIAcBwchnTc.png)
---
...
### **Methods**
![image](/images/DgQMb6qIco9naKxhiWzc6TAHnWh.png)
...
### **Scores**
![image](/images/VOZFbT9N3o9iaBxCQUicNL47nKe.png)
...
---
![image](/images/YRIEbmTgqorENvx2tmDcVrIbnff.png)
### **MAG**


### **DTP**
**事实证明，单模态压缩中的动态令牌修剪比静态令牌修剪更有效，因为它可以根据输入实例的复杂程度自适应调整模型的压缩率。**
![image](/images/GZqrbdyPSoDvgAx8octcFCM0nvE.png)
### **TIS**
$$
...
![image](/images/PzhNbrL9SocCajxN5CncqrLDnJe.png)
---
### **Observations**
...
![image](/images/ZtWWbX6aHo8m1Cx9xQdcZulHnEe.png)

**然后做了3个study：各种可视化去探究LLM对于textual和visual信息的处理随着层数变化的改变情况**
![image](/images/OQvkb3nnuopOgrxweM2cPr0sn5I.png)
...
![image](/images/IO9vbikGqoUEXwxNisucXMZHnG0.png)
...
### **Methods**
![image](/images/MtSRbnAfHoWKSexJlXGctCgDn4e.png)
...
![image](/images/IjGpbXnSroa5uoxmbiAcdZzIn9g.png)
---

## **Accelerating Pre-training of Multimodal LLMs via Chain-of-Sight**
![image](/images/DI3hbanZloB0KCxy4iccxpavnEe.png)
---
### **Brief Introduction **
...
![image](/images/HSSVbssrXodcvmxT2z4ciYR5n8d.png)
```plaintext
...
![image](/images/BPBibeDZZokNk6xe0LycsqwXnuc.png)
...
$$
来表示
![image](/images/UeyTbGK3WooyitxO2oMcFFf1nCd.png)
1. $$
...
![image](/images/SY4EbGvNooVYiHxdTXNcVt8LnVd.png)
...
![image](/images/JSx0b7dyYoGy5Mx5eBycHMj2nPg.png)
- 常见两种数据流：
...
![image](/images/TpsdbnDStoCzBSxZFhhcYIMFnsc.png)
---
### Background & Target
---
